...
**Phase Scrubber** - A horizontal track at the bottom of the trajectory panel with seven clickable phase dots, spaced according to actual mission elapsed time. Clicking any dot jumps the entire dashboard to that phase of the mission. A play/pause button runs real-time animation from any position.
